	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (circlepercent != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://forum.xda-developers.com/attachment.php?attachmentid=1738177&stc=1&d=1361125906",
							R.drawable.default_img, 60000);
		}
		if (circles != null) {
		...
		if (digital != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://forum.xda-developers.com/attachment.php?attachmentid=1768332&stc=1&d=1362062335",
							R.drawable.default_img, 60000);
		}
		if (dotted != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://forum.xda-developers.com/attachment.php?attachmentid=1754013&stc=1&d=1361622539",
							R.drawable.default_img, 60000);
		}
		if (fullcircle1 != null) {
		...
		if (fullcircle2 != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://forum.xda-developers.com/attachment.php?attachmentid=1720115&stc=1&d=1360581542",
							R.drawable.default_img, 60000);
		}
		if (gauge != null) {
		...
		if (honeycomb != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://forum.xda-developers.com/attachment.php?attachmentid=1754014&stc=1&d=1361622539",
							R.drawable.default_img, 60000);
		}
		if (stock != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Stock/example.png",
							R.drawable.default_img, 60000);
		}
		if (stockblue != null) {
			UrlImageViewHelper
		...
		if (green != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Stock%20Green/example.png",
							R.drawable.default_img, 60000);
		}
		if (pink != null) {
			UrlImageViewHelper
		...
		if (galaxy != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Galaxy/example.png",
							R.drawable.default_img, 60000);
		}
		if (galaxyblue != null) {
			UrlImageViewHelper
		...
		if (reflect != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Stock%20Reflect/example.png",
							R.drawable.default_img, 60000);
		}
		if (reflectblue != null) {
			UrlImageViewHelper
		...
		if (razor != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/RAZR%20HD/example.png",
							R.drawable.default_img, 60000);
		}
		if (razorblue != null) {
			UrlImageViewHelper
		...
		if (small != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Stock%20Small/example.png",
							R.drawable.default_img, 60000);
		}
		if (smallblue != null) {
			UrlImageViewHelper
		...
		if (smallreflect != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Stock%20Small%20Reflect/example.png",
							R.drawable.default_img, 60000);
		}
		...
		if (xperia != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Xperia/example.png",
							R.drawable.default_img, 60000);
		}
		if (xperiablue != null) {
			UrlImageViewHelper
		...
		if (zte != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/ZTE%20Grand/example.png",
							R.drawable.default_img, 60000);
		}
		if (zteblue != null) {
			UrlImageViewHelper
		...
		if (college != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Fonts/College/example.png",
							R.drawable.default_img, 60000);
		}
		if (collegeblue != null) {
			UrlImageViewHelper
		...
		if (defused != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Fonts/Defused/example.png",
							R.drawable.default_img, 60000);
		}
		if (defusedblue != null) {
			UrlImageViewHelper
		...
		if (droid != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Fonts/Droid/example.png",
							R.drawable.default_img, 60000);
		}
		if (droidblue != null) {
			UrlImageViewHelper
		...
		if (pixel != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Fonts/Pixel/example.png",
							R.drawable.default_img, 60000);
		}
		if (pixelblue != null) {
			UrlImageViewHelper
		...
		if (facebook != null) {
			UrlImageViewHelper
					.setUrlDrawable(
							batteryView,
							"http://dl.dropbox.com/u/1983605/Softkeys/Facebook/example.png",
							R.drawable.default_img, 60000);
		}
